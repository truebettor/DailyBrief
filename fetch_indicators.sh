...
API_KEY="${ALPHA_VANTAGE_API_KEY:-HWR8A1LVSYO4C2GX}"
...
NZDCNY=$(echo "$NZDCNY" | python3 -c "import sys,json; data=json.load(sys.stdin); print(data['Realtime Currency Exchange Rate']['5. Exchange Rate'])" 2>/dev/null || echo "N/A")
